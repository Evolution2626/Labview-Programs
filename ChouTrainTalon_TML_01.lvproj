		...
		<Item Name="Sim Support Files" Type="Folder">
			<Item Name="FRC SimulatedRSC" Type="Folder">
				<Item Name="ive" Type="Folder">
					<Item Name="4in Perf Wheel.ive" Type="Document" URL="../ChouTrain_TML_04/FRC SimulatedRSC/ive/4in Perf Wheel.ive"/>
					<Item Name="AXIS M1011.ive" Type="Document" URL="../ChouTrain_TML_04/FRC SimulatedRSC/ive/AXIS M1011.ive"/>
					<Item Name="Devantech SRF05.ive" Type="Document" URL="../ChouTrain_TML_04/FRC SimulatedRSC/ive/Devantech SRF05.ive"/>
					<Item Name="FRC - Body.ive" Type="Document" URL="../ChouTrain_TML_04/FRC SimulatedRSC/ive/FRC - Body.ive"/>
					<Item Name="Honeywell HMC6343.ive" Type="Document" URL="../ChouTrain_TML_04/FRC SimulatedRSC/ive/Honeywell HMC6343.ive"/>
					<Item Name="Sparkfun Atomic IMU.ive" Type="Document" URL="../ChouTrain_TML_04/FRC SimulatedRSC/ive/Sparkfun Atomic IMU.ive"/>
				</Item>
			</Item>
			<Item Name="FRC Simulated.xml" Type="Document" URL="../ChouTrain_TML_04/FRC Simulated.xml"/>
		</Item>
		<Item Name="Robot Simulation Readme.html" Type="Document" URL="../ChouTrain_TML_04/Robot Simulation Readme.html"/>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Support Code" Type="Folder">
			<Item Name="Elapsed Times.vi" Type="VI" URL="../ChouTrain_TML_04/Elapsed Times.vi"/>
		</Item>
		<Item Name="Team Code" Type="Folder">
			<Item Name="auto avance ralentir.vi" Type="VI" URL="../ChouTrain_TML_04/auto avance ralentir.vi"/>
			<Item Name="Autonomous Independent.vi" Type="VI" URL="../ChouTrain_TML_04/Autonomous Independent.vi"/>
			<Item Name="avancer.vi" Type="VI" URL="../ChouTrain_TML_04/avancer.vi"/>
			<Item Name="Begin.vi" Type="VI" URL="../ChouTrain_TML_04/Begin.vi"/>
			<Item Name="Disabled.vi" Type="VI" URL="../ChouTrain_TML_04/Disabled.vi"/>
			<Item Name="Finish.vi" Type="VI" URL="../ChouTrain_TML_04/Finish.vi"/>
			<Item Name="Periodic Tasks.vi" Type="VI" URL="../ChouTrain_TML_04/Periodic Tasks.vi"/>
			<Item Name="PID_auto.vi" Type="VI" URL="../DashboardFRC2016_TML_01/PID_auto.vi"/>
			<Item Name="Robot Global Data.vi" Type="VI" URL="../ChouTrain_TML_04/Robot Global Data.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../ChouTrain_TML_04/Teleop.vi"/>
			<Item Name="Test.vi" Type="VI" URL="../ChouTrain_TML_04/Test.vi"/>
			<Item Name="Tourner_Gyros.vi" Type="VI" URL="../ChouTrain_TML_04/Tourner_Gyros.vi"/>
			<Item Name="Vision Processing.vi" Type="VI" URL="../ChouTrain_TML_04/Vision Processing.vi"/>
		</Item>
		<Item Name="Robot Main.vi" Type="VI" URL="../ChouTrain_TML_04/Robot Main.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
